...
.demo-card .vh-viewport { height: 480px; }.demo-grid .vh-viewport { height: 640px; }.demo-card--large .vh-viewport { height: 330px; }
...
@media (max-width: 900px) { .nav-links a:not(.github-link) { display: none; }.hero { grid-template-columns: 1fr; padding-top: 55px; }.hero-visual { height: 440px; }.feature-strip { grid-template-columns: repeat(2, 1fr); }.feature-strip div { border-bottom: 1px solid #e5eaf0; }.demo-grid, .quick-start { grid-template-columns: 1fr; }.quick-start { gap: 45px; }.demo-grid .vh-viewport { height: 640px; } }
